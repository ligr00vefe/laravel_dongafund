...
include_once dirname(__FILE__, 2).'/include/sso_entry.php';
...
<?php
if(!strcmp(SSO_SESSION_ANONYMOUSE, $eXSignOnUserId)) {
?>
...
<p>* <span class="font_bold">RelayState</span> (옵션) : 모든 SSO 인증 절차를 거친 후 이동 할 URL 지정. RelayState가 없을 경우 SP 시스템의 Context path 요청</p>
  ...
  <tr>
    <td>샘플 코드</td>
    <td>
<p>&lt;form id=&quot;idpLoginFrm&quot; name=&quot;idpLoginFrm&quot; method=&quot;post&quot; action=&quot;../sso/sso_idp_login.php&quot;&gt;</p>
<p>&nbsp;&nbsp;&lt;input type=&quot;hidden&quot; name=&quot;<?= RELAY_STATE_NAME ?>&quot; value=&quot;/exsignon/sample/main.php&quot; /&gt;</p>
...
<p>&lt;/form&gt;</p>
  ...
  <tr>
    <th colspan="2">
<form id="idpLoginFrm" name="idpLoginFrm" method="post" action="../sso/sso_idp_login.php">
  <input  value="통합 로그인 요청" type="submit" />
  <input type="hidden" name="<?= RELAY_STATE_NAME ?>" value="/exsignon/sample/main.php" />
</form>
    </th>
  </tr>
</table>
...
<table>
  ...
  <tr>
    <td>요청 URL</td>
    <td>&nbsp;https://인증서버URL/svc/tk/Login.eps</td>
  </tr>
  <tr>
    <td>파라미터</td>
    <td>
...
<p>* <span class="font_bold">RelayState</span> (옵션) : 모든 SSO 인증 절차를 거친 후 이동 할 URL 지정. RelayState가 없을 경우 SP 시스템의 Context path 요청</p>
  ...
  <tr>
    <td>샘플 코드</td>
    <td>
<p>&lt;form id=&quot;spLoginFrm&quot; name=&quot;spLoginFrm&quot; method=&quot;post&quot; action=&quot;<?= generateUrl(IDP_URL, LOGIN_URL) ?>&quot;&gt;</p>
<p>&nbsp;&nbsp;&lt;input type=&quot;hidden&quot; name=&quot;<?= RELAY_STATE_NAME ?>&quot; value=&quot;/exsignon/sample/main.php&quot; /&gt;</p>
...
<p>&lt;/form&gt;</p>
  ...
  <tr>
    <th colspan="2">
<form id="spLoginFrm" name="spLoginFrm" method="post" action="<?= generateUrl(IDP_URL, LOGIN_URL) ?>">
  <input type="hidden" name="<?= RELAY_STATE_NAME ?>" value="/exsignon/sample/main.php" />
...
<p>* <span class="font_bold">RelayState</span> (옵션) : 모든 SSO 인증 절차를 거친 후 이동 할 URL 지정. RelayState가 없을 경우 SP 시스템의 Context path 요청</p>
  ...
  <tr>
    <td>샘플 코드</td>
    <td>
<p>&lt;form id=&quot;assertLoginFrm&quot; name=&quot;assertLoginFrm&quot; method=&quot;post&quot; action=&quot;../sso/sso_assert.php&quot;&gt;</p>
...
&lt;/form&gt;</p>
  ...
  <tr>
    <th colspan="2">
<form id="assertLoginFrm" name="assertLoginFrm" method="post" action="../sample/sso_pre_assert.php">
...
<table>
  ...
  <tr>
    ...
    <p>&nbsp;logout.php 파일을 요청하게 되며 logout.php에서는 session invalidate 후 SSO 통합 로그아웃을 요청한다.</p>
    </td>
  </tr>
  <tr>
    <td>요청 URL</td>
    <td>&nbsp;/sso/logout.php</td>
  </tr>
  <tr>
    <td>파라미터</td>
    <td>
<p>* <span class="font_bold">RelayState</span> (옵션) : 모든 SSO 로그아웃 절차를 거친 후 이동 할 URL 지정. RelayState가 없을 경우 SP 시스템의 Context path 요청</p>
  ...
  <tr>
    <th colspan="2">
<form id="logoutFrm" name="logoutFrm" method="post" action="../sso/logout.php">
